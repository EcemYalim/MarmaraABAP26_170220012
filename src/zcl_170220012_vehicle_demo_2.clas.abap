CLASS zcl_170220012_vehicle_demo_2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170220012_vehicle_demo_2 IMPLEMENTATION.
  ...
  SELECT SINGLE * FROM zvhc_170220012 WHERE id = '1' INTO @DATA(ls_data).
